    ...
    <script type="text/javascript">
      ...
      function playNextMedia(){
        ...
        $.getJSON(url, function(result){
          ...
          title = result[mediaNumber];
          var pattPic= /^[1-9].*\.(bmp|jpeg|png|jpg)$/i;
          var pattVid= /^[1-9].*\.(mp4|mkv|webm)$/i;
      ...
      function playVideo(title,ext){
        $('#video').add('<source src="<?php echo base_url('assets/playlist/')?>'+title+'" type="video/mp4">').attr('volume','0').attr('autoplay','true').appendTo('#video')
      ...
      function playImage(title,ext){
        $('#image').attr('src','<?php echo base_url('assets/playlist/')?>'+title)
